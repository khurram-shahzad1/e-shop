...
if(isset($_GET['date'])){
  ...
  if($date == 'week'){
    $currDate = date('Y-m-d');
    $lastWeek = date('Y-m-d', strtotime($currDate. ' -7 days'));
    echo $currDate . "<br>";
    echo $lastWeek . "<br>";
    $totalOrderQ = mysqli_query($conn , "SELECT COUNT(id) FROM `orders` WHERE `timestamp` BETWEEN '$lastWeek' AND '$currDate'");
    $pendingOrderQ = mysqli_query($conn , "SELECT COUNT(id) FROM `orders` WHERE `status` != '3' AND `status` != '4' AND `timestamp` BETWEEN '$lastWeek' AND '$currDate' ");
    $completedOrderQ = mysqli_query($conn , "SELECT COUNT(id) FROM `orders` WHERE `status` = '3' AND `timestamp` BETWEEN '$lastWeek' AND '$currDate' ");
    $earningsOrderQ = mysqli_query($conn , "SELECT SUM(paid) FROM `orders` WHERE `timestamp` BETWEEN '$lastWeek' AND '$currDate'");
    $totalUsersQ = mysqli_query($conn , "SELECT COUNT(id) FROM `users` WHERE `timestamp` BETWEEN '$lastWeek' AND '$currDate'");
  }
  if($date == 'month'){
    $currDate = date('Y-m-d');
    $lastMonth = date('Y-m-d', strtotime($currDate. ' -1 months'));
    echo $currDate . "<br>";
    echo $lastMonth . "<br>";
    $totalOrderQ = mysqli_query($conn , "SELECT COUNT(id) FROM `orders` WHERE `timestamp` BETWEEN '$lastMonth' AND '$currDate'");
    $pendingOrderQ = mysqli_query($conn , "SELECT COUNT(id) FROM `orders` WHERE `status` != '3' AND `status` != '4' AND `timestamp` BETWEEN '$lastMonth' AND '$currDate' ");
    $completedOrderQ = mysqli_query($conn , "SELECT COUNT(id) FROM `orders` WHERE `status` = '3' AND `timestamp` BETWEEN '$lastMonth' AND '$currDate' ");
    $earningsOrderQ = mysqli_query($conn , "SELECT SUM(paid) FROM `orders` WHERE `timestamp` BETWEEN '$lastMonth' AND '$currDate'");
    $totalUsersQ = mysqli_query($conn , "SELECT COUNT(id) FROM `users` WHERE `timestamp` BETWEEN '$lastMonth' AND '$currDate'");
  }
  if($date == 'year'){
    $currDate = date('Y-m-d');
    $lastYear = date('Y-m-d', strtotime($currDate. ' -1 years'));
    echo $currDate . "<br>";
    echo $lastYear . "<br>";
    $totalOrderQ = mysqli_query($conn , "SELECT COUNT(id) FROM `orders` WHERE `timestamp` BETWEEN '$lastYear' AND '$currDate'");
    $pendingOrderQ = mysqli_query($conn , "SELECT COUNT(id) FROM `orders` WHERE `status` != '3' AND `status` != '4' AND `timestamp` BETWEEN '$lastYear' AND '$currDate' ");
    $completedOrderQ = mysqli_query($conn , "SELECT COUNT(id) FROM `orders` WHERE `status` = '3' AND `timestamp` BETWEEN '$lastYear' AND '$currDate' ");
    $earningsOrderQ = mysqli_query($conn , "SELECT SUM(paid) FROM `orders` WHERE `timestamp` BETWEEN '$lastYear' AND '$currDate'");
    $totalUsersQ = mysqli_query($conn , "SELECT COUNT(id) FROM `users` WHERE `timestamp` BETWEEN '$lastYear' AND '$currDate'");
  }
